                ...
                <div className="Con-container">
                    <div className="Con-info-side">
                        ...
                        <div className="Con-contact-quick-links">
                            <div className="Con-link-item">
                                <FaPhoneAlt className="Con-large-icon" /> 
                                <span>+94 72 104 6048</span>
                            </div>
                            <div className="Con-link-item">
                                <FaEnvelope className="Con-large-icon" /> 
                                <span>donotreply.ALUX@gmail.com</span>
                            </div>
                            <div className="Con-link-item">
                                <FaMapMarkerAlt className="Con-large-icon" /> 
                                <span>426F Shanthi Garden,<br />Alubomulla, Panadura</span>
                            </div>
                        </div>
                    ...
                    <div className="Con-form-side">
                        <form onSubmit={handleSubmit} className="Con-real-form">
                            ...
                            {submitSuccess && <div className="Con-success-box">Message sent successfully! We'll get back to you soon.</div>}
                            {submitError && <div className="Con-error-box">{submitError}</div>}
                        </form>
                    </div>
                </div>
            </div>
