...
import EmailListItem from './EmailListItem'; // Import the new item component
import './EmailDisplay.css'; // Continue using the same CSS file
...
const EmailList = ({ emails = [], initialSelectedId = null }) => {
    ...
    const handleSelectEmail = (id) => {
        ...
        // Optional: Add callback logic here if the parent needs to know
        // e.g., onEmailSelected(id);
        console.log("Selected email ID:", id);
    };

    // Sort emails by date, newest first (optional, adjust as needed)
...
// Default props with multiple emails for demonstration
EmailList.defaultProps = {
    emails: [
        ...
        {
            id: 'email_4',
            from: { email: 'alert@monitoring.com' }, // No name example
            to: [{ email: 'user@example.com' }],
        ...
        },
         {
            ...
            attachments: [
                ...
                { name: 'archive.zip', size: '5.8 MB' } // Example without URL
            ]
        }
    ],
    initialSelectedId: null // No email selected initially by default
};
